	...
	this.frame_0 = function() {
		...
		function myClick(event) { //פונצקיה המופעלת בכל לחיצה על קטגוריה נבחרת על הפחית
			...
			if (typeof txt != 'string') {
				...
				myBoard.removeEventListener('mouseover', myClick_mouseover); 
			...
			for (var i = 0; i < myBtns[qnum].length; i++) { //לאחר מענה הסרת האפשרות ללחוץ על הפחיות
				stage.getChildByName("btn" + i).removeEventListener('click', myClick);
				stage.getChildByName("btn" + i).removeEventListener('mouseover', myClick_mouseover);
			}
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Hayarid_atlas_P_.png?1518034522593", id:"Hayarid_atlas_P_"},
		{src:"images/Hayarid_atlas_NP_.jpg?1518034522593", id:"Hayarid_atlas_NP_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1518034522650", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1518034522650", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1518034522650", id:"an.CSS"},
		{src:"components/ui/src/combobox.js?1518034522650", id:"an.ComboBox"}
	],
	preloads: []
};
