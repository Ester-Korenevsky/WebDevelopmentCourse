...
(lib.Hayarid = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function pressOdot() { //לחיצה על אודות
			...
			if (onstage == false) { //אם זהוו לא מסך הכניסה
		...
		function pressAxe() { ///איקס' סגירת אודות
			...
			if (onstage == false) { //אם זהו לא מסך הכניסה
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Hayarid_atlas_P_.png?1518127967432", id:"Hayarid_atlas_P_"},
		{src:"images/Hayarid_atlas_NP_.jpg?1518127967432", id:"Hayarid_atlas_NP_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1518127967497", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1518127967497", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1518127967497", id:"an.CSS"},
		{src:"components/ui/src/combobox.js?1518127967497", id:"an.ComboBox"}
	],
	preloads: []
};
